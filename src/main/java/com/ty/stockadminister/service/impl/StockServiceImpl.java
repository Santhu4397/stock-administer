...
public class StockServiceImpl implements Stockservice{
	...
	public ResponseEntity<ResponseStructure<Stock>> saveService(Stock stock) {
		...
		ResponseEntity<ResponseStructure<Stock>> entity=new ResponseEntity<ResponseStructure<Stock>>(structure,HttpStatus.OK);
     	return entity;		
	...
	public ResponseEntity<ResponseStructure<List<Stock>>> getStock() {
		...
		responseStructure.setData(dao.getStock());
		 ResponseEntity<ResponseStructure<List<Stock>>> entity=new  ResponseEntity<ResponseStructure<List<Stock>>>(responseStructure,HttpStatus.OK);
		return entity;
	...
	public ResponseEntity<ResponseStructure<Stock>> updateStock(int id, Stock stock) {
		...
		responseStructure.setData(dao.updateStock(id, stock));
		 ResponseEntity<ResponseStructure<Stock>> entity=new  ResponseEntity<ResponseStructure<Stock>>(responseStructure,HttpStatus.OK);
		return entity;
		}else {
			ResponseStructure<Stock> responseStructure=new ResponseStructure<Stock>();
			...
			responseStructure.setData(null);
			 ResponseEntity<ResponseStructure<Stock>> entity=new  ResponseEntity<ResponseStructure<Stock>>(responseStructure,HttpStatus.NOT_FOUND);
			return entity;
		}
